...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ka,depthTest:!1,depthWrite:!1})}function nR(o,e,i){return new Sa({name:"SphericalGaussianBlur",defines:{SAMPLES:QA,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${o}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Qu(),fragmentShader:`
		...
		`,blending:ka,depthTest:!1,depthWrite:!1})}function Dx(){return new Sa({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qu(),fragmentShader:`
		...
		`,blending:ka,depthTest:!1,depthWrite:!1})}function Ux(){return new Sa({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qu(),fragmentShader:`
...
`)}const ow={[aS]:"Linear",[sS]:"Reinhard",[rS]:"Cineon",[oS]:"ACESFilmic",[cS]:"AgX",[uS]:"Neutral",[lS]:"Custom"};function lw(o,e){const i=ow[e];return i===void 0?(oe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+o+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+o+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Lu=new nt;function cw(){Oe.getLuminanceCoefficients(Lu);const o=Lu.x.toFixed(4),e=Lu.y.toFixed(4),i=Lu.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Rl).join(`
`)),h=em(h),h=Vx(h,i),h=kx(h,i),d=em(d),d=Vx(d,i),d=kx(d,i),h=Xx(h),d=Xx(d),i.isRawShaderMaterial!==!0&&(U=`#version 300 es
...
`)+`
`+S);const F=U+y+h,N=U+S+d,D=Fx(l,l.VERTEX_SHADER,F),L=Fx(l,l.FRAGMENT_SHADER,N);l.attachShader(C,D),l.attachShader(C,L),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.hasPositionAttribute===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function I(k){if(o.debug.checkShaderErrors){const Q=l.getProgramInfoLog(C)||"",st=l.getShaderInfoLog(D)||"",Y=l.getShaderInfoLog(L)||"",tt=Q.trim(),q=st.trim(),j=Y.trim();let dt=!0,ut=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(dt=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,C,D,L);else{const rt=Gx(l,D,"vertex"),Tt=Gx(l,L,"fragment");He("WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
