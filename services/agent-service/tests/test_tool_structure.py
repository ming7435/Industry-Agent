...
def test_agent_tools_are_split_by_tool_name() -> None:
    expected_tool_files = {
        ...
        "quality/get_production_part.py",
        "quality/get_part_specification.py",
        "quality/inspect_part_dimensions.py",
        "quality/inspect_part_appearance.py",
        "quality/inspect_part_material.py",
        "quality/inspect_part_function.py",
        "quality/inspect_part_process.py",
